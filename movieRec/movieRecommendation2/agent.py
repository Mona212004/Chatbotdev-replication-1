...
from .tools_dir.greet.agent import greeting_agent, sayHello
from .tools_dir.preference_manager.agent import preference_manager_agent, get_preferences, update_preferences, remove_preferences, remove_all_preferences
from .tools_dir.find_title.agent import movie_finder_agent
from .tools_dir.find_title.find_movie_tool import find_movie_title
from .tools_dir.retrieve_movie_info import get_movie_info
...
try:
    root_agent = LlmAgent(
        ...
        tools=[sayHello, get_preferences, update_preferences, remove_preferences, remove_all_preferences, find_movie_title, get_movie_info],
    )
